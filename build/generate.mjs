...
<style>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .logo{display:inline-flex;align-items:center;gap:.55rem;color:var(--blue-900)}
  .logo svg{height:26px}
  .logo b{font-weight:700;font-size:1rem}.logo b i{font-style:italic;color:var(--blue-500)}
  .logo small{font-family:'IBM Plex Mono',monospace;text-transform:uppercase;letter-spacing:.22em;font-size:.52rem;color:var(--blue-600);margin-left:.15rem}
...
<header><div class="wrap bar">
  <a class="logo" href="/" aria-label="V4 Aero Flight — início">
    <svg viewBox="0 0 48 48" aria-hidden="true"><path d="M24 4 L24 33 L6 42 Z" fill="#061423"/><path d="M24 4 L42 42 L24 33 Z" fill="#3E77AE"/></svg>
    <span><b>V4 <i>Aero</i></b><small>Flight</small></span>
  </a>
